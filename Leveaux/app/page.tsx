...
const Hero1 = () => {
  ...
  <h2 className="mb-3 text-3xl font-semibold md:mb-4 md:text-4xl lg:mb-6 text-center ml-16">
    Notre Collection
  </h2>
  <div className="flex justify-center">
    <a
      href="https://www.shadcnblocks.com"
      className="group inline-flex items-center justify-center gap-1 text-sm font-medium md:text-base lg:text-lg hover:text-cyan-800 transition duration-transition duration-200 ml-16"
    >
      En savoir plus
            ...
            {data.map((item) => (
              ...
              >
				...
				<div
					...
					style={{
						backgroundImage:
							"url('Capture dՎcran 2025-02-04 102634.png')",
					}}
				>
