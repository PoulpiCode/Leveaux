  ...
  useEffect(() => {
	...
	return (
		<section className="w-full h-full">
			    <section 
      className="relative w-full min-h-screen bg-cover bg-center flex flex-col justify-center items-center text-white"
      style={{ backgroundImage: "url('/Capture d’écran 2025-01-29 133859.png')" }}
    >
      {/* Overlay pour améliorer la lisibilité du texte */}
      <div className="absolute inset-0 bg-black/25"></div>

      <div className="relative z-10 flex flex-col items-center gap-6 text-center w-full px-4">
        {/* Grand Titre placé plus haut */}
        <h1 className="text-5xl sm:text-7xl lg:text-8xl font-semibold drop-shadow-lg mt-[-100px] underline py-8">
        Broderie Leveaux
        </h1>

        <p className="text-lg sm:text-2xl lg:text-5xl w-4/5 md:w-3/5 leading-relaxed">
          Votre spécialiste tricolore de la broderie et du savoir-faire artisanal à créativité moderne.
        </p>
        <div className="">
    ...
    <div className="mb-8 flex flex-col justify-between md:mb-14 md:flex-row md:items-end lg:mb-16">
      <div className="w-full text-center relative">
        <div className="absolute bottom-[-118%] left-[2%] w-[14%] flex items-center justify-center">
          ...
          <span className="text-black text-font font-italiano text-font-italiano text-base">Découvrez notre collection</span>
        </div>
        ...
        <a
          href="https://www.shadcnblocks.com"
          className="group inline-flex items-center justify-center gap-1 text-sm font-medium md:text-base lg:text-lg hover:text-cyan-800 transition duration-transition duration-200"
        >
          Pour en voir plus
				...
				>
					...
					<div className="relative z-10 flex w-full flex-col items-center justify-center">
						...
						<h3 className="w-3/5 text-white text-wrap text-right text-3xl flex-col font-bold">
							Notre programme pour un développement durable
							<br />
						</h3>
